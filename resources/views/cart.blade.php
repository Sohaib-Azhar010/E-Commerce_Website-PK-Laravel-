        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (cartData) {
                ...
                cartArray.forEach(function(item) {
                    ...
                    var existingProductDiv = findProductDiv(cartContainer, item.title);

                    if (existingProductDiv) {
                        // Increment the quantity of the existing item
                        incrementQuantity(existingProductDiv);

                    } else {
                        // Create a new productDiv if the item doesn't exist
            ...
            // Function to find the existing productDiv for a given product title
            function findProductDiv(cartContainer, productName) {
                return Array.from(cartContainer.children).find(function(productDiv) {
                    return productDiv.querySelector('.productname').textContent === productName;
                });
            }

            // Function to increment the quantity of an existing item
            function incrementQuantity(existingProductDiv) {
                var quantityInput = existingProductDiv.querySelector('.productquantity');
                quantityInput.value = parseInt(quantityInput.value) + 1;

                // Call the updateQuantity function to recalculate total price and update cart summary
            ...
            function updateQuantity(quantityInput) {
                ...
                if (cartData) {
                    ...
                    productTotal.textContent = `Rs ${(newQuantity * parseFloat(cartItem.price.replace('Rs', ''))
        ).toFixed(2)}`;
