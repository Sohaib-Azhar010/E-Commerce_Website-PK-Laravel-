...
<html lang="en">
  ...
  <body>
    <nav class="nav1">
      <div class="nav1left">
        ...
        <a href=""
          ><img src="Imgs/telephone-call.png" alt="" />+92-300-0000000</a
        >
      </div>
      <div class="nav1right">
    ...
    <div class="loginform">
      ...
      <form name="signup_login" method="post" action="/Signed" onsubmit="return validateFormSignUp()" >
        @csrf
        <div class="input-field" id="namefield">
          <img src="loginimgs/user-solid.svg" alt="" />
          <input type="text" name="username" id="" placeholder="Name" />
        </div>
        <div class="input-field">
          <img src="loginimgs/envelope-solid.svg" alt="" />
          <input type="email" name="usermail" id="" placeholder="Email" required />
        </div>
        <div class="input-field">
          <img src="loginimgs/lock-solid.svg" alt="" />
          <input
            type="password"
            name="userpass"
            id=""
        ...
        <div class="input-field" id="confirmpassblock">
          <img src="loginimgs/lock-solid.svg" alt="" />
          <input
            type="password"
            name="confirmpass"
        ...
        <p id="forgetpass" style="display: none;">
          Forgot Password?<a href="" style="margin-left: 4px;">Click here</a>
        </p>
        <hr />

        <div class="form-btn">
          <button type="submit" name="signupbtn" id="signupbtn" >Sign Up</button>
          <button type="submit" name="signinbtn" class="disable" id="signinbtn" onclick="f1();">
            Sign In
          </button>
        </div>
      </form>
    ...
    <section class="hotproducts">
      ...
      <div class="hotproducts2">
        <div class="product-card">
          ...
          <div class="product-image">
            <img
              src="Accessoriesimgs/men_perf2-removebg-preview.png"
            />
          </div>
        </div>
        <div class="product-card">
    ...
    <script
      src="https://kit.fontawesome.com/cb4d775616.js"
      crossorigin="anonymous"
    ></script>
    ...
    <script>
      ...
      var siginpbtn = document.getElementById("signinpbtn");
      var namefield = document.getElementById("namefield");
      var title = document.getElementById("formtitle");
      var confirmpass=document.getElementById("confirmpassblock");
  ...
  var username = document.forms["signup_login"]["username"].value;
  var email = document.forms["signup_login"]["usermail"].value;
  var password = document.forms["signup_login"]["userpass"].value;

  if (username.trim() === "") {
    document.getElementById('warn').innerHTML= "Username can't be empty";
    return false;
  }
  if (username.length > 15) {
    document.getElementById('warn').innerHTML= "Username can't exceed 15 letters";
    return false;
  }
  if (email.trim() === "") {
    document.getElementById('warn').innerHTML= "Email can't be empty";
    return false;
  }
  if (!email.endsWith('@gmail.com')) {
  ...
  if (password.trim() === "") {
    document.getElementById('warn').innerHTML= "Password can't be empty";
    return false;
  }
  if (password.length < 8) {
    document.getElementById('warn').innerHTML= "Password must be atleast 8 letters";
    return false;
  }
