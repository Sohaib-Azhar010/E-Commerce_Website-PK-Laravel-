        ...
        <section class="billing">
          ...
          <section class="billingform">
            <div class="left">
              ...
              <input type="text" name="fname" id="" placeholder="Firstname here" required><br>
              <label for="billingemail">E-Mail</label><br>
              <input type="email" name="billingemail" id="" placeholder="username@gmail.com" required><br>
              <label for="address1">Billing Address</label>
              <input type="text" name="address1" id="" placeholder="Address Here" required><br>
              ...
              <input type="text" name="province" id="" placeholder="Province Name" required>
            </div>
            <div class="right">
              <label for="lname">Last Name</label>
              <input type="text" name="lname" id="" placeholder="Lastname here" required><br>
              ...
              <input type="text" name="city" id="" placeholder="City Name" required><br>
        ...
        <section class="payment">
          ...
          <div class="p_right">
            ...
            <div class="p_rightdiv">
              ...
              <input type="radio" name="paymentmethod" id=""value="bank">
