                    ...
                    <table class="table table-bordered table-hover bg-white">
                        <thead class="table-dark bg-dark">
                            <tr>
                                ...
                                <th scope="col" class="text-center align-middle">Serial No.</th>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <img src="{{ $product->picture }}" alt="Product Image"
                                                ...
                                                style="max-width:7vw;text-align:center ">
                                        </td>
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            {{-- <div class="mb-2">
                                                <form action="{{ route('addToPage', ['productId' => $product->id]) }}" method="post">
                                                    @csrf
                                                <button type="submit"
                                                    class="btn btn-warning btn-sm add-to-page-btn"
                                                    data-product-id="{{ $product->id }}"
                                                    data-product-type="{{ $product->product_type }}"
                                                    data-product-name="{{ $product->name }}"
                                                    data-product-price="{{ $product->price }}"
                                                    data-product-serial-no="{{ $product->serial_no }}">Add to
                                                    Page</button>
                                                </form>
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-success btn-sm del"
